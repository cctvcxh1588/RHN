      ...
      <div className="max-w-7xl mx-auto p-6 lg:p-10">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 mb-8">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <a
              href="/admin/cms"
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-accent-gold text-primary-deep hover:bg-accent-gold/90 text-sm font-medium transition-colors"
            >
              CMS Editor →
            </a>
            <button
