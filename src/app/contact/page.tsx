...
import { Mail, MapPin, Send, MessageSquare, User, Phone, Globe, ExternalLink, ChevronRight } from 'lucide-react';
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          <RevealOnScroll>
            ...
            <p className="text-lg md:text-xl text-white/80 max-w-2xl mx-auto">
              Get in touch with the Round Hainan Regatta Organizing Committee.
              We&apos;re here to help.
            </p>
          </RevealOnScroll>
        </div>
          ...
          <RevealOnScroll>
            <div className="text-center mb-16">
              ...
              <p className="text-base text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                Have a question about registration, sponsorship, or the race?
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start gap-5 p-6 bg-surface-container rounded-2xl hover:shadow-card transition-shadow">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground/70 mt-1">
                      Sanya Serenity Marina — Race Village
                    </p>
                  </div>
                </div>
                ...
                <div className="p-6 bg-gradient-to-br from-primary-deep to-primary rounded-2xl text-white">
                  ...
                  <p className="text-sm text-white/70 leading-relaxed">
                    Sanya Serenity Marina, Hainan, China
                  </p>
                  <div className="mt-4 pt-4 border-t border-white/20">
                    <Link
                      href="/contact"
                      className="inline-flex items-center gap-2 text-sm font-semibold text-accent-gold hover:text-accent-yellow transition-colors"
                    >
                      Register Interest
                ...
                <form id="contact-form" onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    <label
                      ...
                      className="block text-sm font-medium text-primary-deep mb-2"
                    >
                  ...
                  {submitted && (
                    <p className="text-center text-sm text-green-600 font-medium">
                      ✓ Thank you! Your message has been received. We&apos;ll be
                      in touch soon.
                    </p>
                  )}
                </form>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <RevealOnScroll>
            <div className="text-center mb-16">
              ...
              <p className="text-base text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                The Round Hainan Regatta Race Village is located at Sanya
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            {/* Map Placeholder */}
            <RevealOnScroll delay={0.1}>
              <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-card bg-primary-deep/10">
                <div
                  className="absolute inset-0 bg-cover bg-center bg-no-repeat"
                  style={{ backgroundImage: "url('/hainan-map.png')" }}
                />
                <div className="absolute inset-0 bg-primary-deep/10" />
                {/* Map pin indicator */}
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                  <div className="relative">
                    <MapPin className="w-10 h-10 text-accent-coral drop-shadow-lg" />
                    <span className="absolute -bottom-6 left-1/2 -translate-x-1/2 text-xs font-semibold text-white bg-primary-deep/80 px-3 py-1 rounded-full whitespace-nowrap">
              ...
              <div className="flex flex-col justify-center space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Fly into Sanya Phoenix International Airport (SYX). The
